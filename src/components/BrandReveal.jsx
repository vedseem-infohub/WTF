  ...
  return (
    <section className="min-h-screen bg-white flex flex-col items-center justify-center relative px-4 py-10 md:py-20 z-20">
      ...
      >
        ...
        {/* Buttons */}
        <div className="flex flex-col md:flex-row gap-4 mt-6 md:mt-8 w-full md:w-auto">
            {/* CTA Button */}
            <motion.a
                href="https://partnerships.wtffoods.in/forms/roll-x"
                target="_blank"
                rel="noopener noreferrer"
                className="px-8 py-3 md:py-4 bg-[#D62828] text-white text-lg md:text-xl font-bold rounded-full hover:bg-red-700 transition-colors duration-300 shadow-lg text-center w-full md:w-auto"
            ...
            >
             ...
             <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer" 
                className="px-8 py-3 md:py-4 bg-white text-[#D62828] border-2 border-[#D62828] text-lg md:text-xl font-bold rounded-full hover:bg-red-50 transition-colors duration-300 shadow-lg text-center w-full md:w-auto"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
            >
                Contact
